...
mod tests {
    ...
    fn add_part(archive: &mut ZipWriter<Cursor<Vec<u8>>>, name: &str, value: &[u8]) {
        archive
            .start_file(
                name,
                SimpleFileOptions::default().compression_method(CompressionMethod::Stored),
            )
            .expect("start OOXML part");
        archive.write_all(value).expect("write OOXML part");
    }

    fn package_with_parts(parts: &[(&str, &[u8])]) -> Vec<u8> {
        let mut archive = ZipWriter::new(Cursor::new(Vec::new()));
        for (name, value) in parts {
            add_part(&mut archive, name, value);
        }
        archive.finish().expect("finish OOXML package").into_inner()
    }
...
<Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types">
  ...
  <Default Extension="png" ContentType="image/png"/>
        ...
        let root_relationships = br#"<?xml version="1.0" encoding="UTF-8"?>
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  <Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="word/document.xml"/>
</Relationships>"#;
        let document_relationships = br#"<?xml version="1.0" encoding="UTF-8"?>
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  <Relationship Id="rIdHyper" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/hyperlink" Target="https://example.test/chapter" TargetMode="External"/>
  <Relationship Id="rIdImage" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/image" Target="media/image1.png"/>
</Relationships>"#;
        let styles = br#"<?xml version="1.0" encoding="UTF-8"?>
<w:styles xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:docDefaults><w:rPrDefault><w:rPr><w:rFonts w:ascii="Noto Serif"/></w:rPr></w:rPrDefault></w:docDefaults>
  <w:style w:type="paragraph" w:styleId="Normal"><w:name w:val="Normal"/></w:style>
  <w:style w:type="paragraph" w:styleId="Heading1"><w:name w:val="Heading 1"/><w:basedOn w:val="Normal"/><w:link w:val="Heading1Char"/><w:pPr><w:outlineLvl w:val="0"/></w:pPr><w:rPr><w:b/></w:rPr></w:style>
  <w:style w:type="character" w:styleId="Heading1Char"><w:name w:val="Heading 1 Char"/><w:rPr><w:color w:val="AA5500"/></w:rPr></w:style>
  <w:style w:type="character" w:styleId="EmphasisChar"><w:name w:val="Emphasis Char"/><w:rPr><w:i/></w:rPr></w:style>
</w:styles>"#;
        let numbering = br#"<?xml version="1.0" encoding="UTF-8"?>
<w:numbering xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:abstractNum w:abstractNumId="0"><w:lvl w:ilvl="0"><w:start w:val="1"/><w:numFmt w:val="decimal"/><w:lvlText w:val="%1."/></w:lvl><w:lvl w:ilvl="1"><w:numFmt w:val="bullet"/><w:lvlText w:val="-"/></w:lvl></w:abstractNum>
...
<w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:wp="http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:pic="http://schemas.openxmlformats.org/drawingml/2006/picture">
  <w:body>
    <w:p><w:pPr><w:pStyle w:val="Heading1"/></w:pPr><w:bookmarkStart w:id="0" w:name="intro"/><w:r><w:rPr><w:b/></w:rPr><w:t>第一章</w:t></w:r><w:bookmarkEnd w:id="0"/></w:p>
    <w:p><w:r><w:t>正文 </w:t></w:r><w:r><w:rPr><w:rStyle w:val="EmphasisChar"/></w:rPr><w:t>强调</w:t></w:r><w:hyperlink r:id="rIdHyper"><w:r><w:t>链接</w:t></w:r></w:hyperlink><w:r><w:br w:type="page"/></w:r><w:r><w:footnoteReference w:id="1"/></w:r><w:r><w:endnoteReference w:id="2"/></w:r><w:r><w:drawing><wp:inline><wp:extent cx="1270000" cy="635000"/><wp:docPr id="1" descr="插图"/><a:graphic><a:graphicData><pic:pic><pic:blipFill><a:blip r:embed="rIdImage"/></pic:blipFill></pic:pic></a:graphicData></a:graphic></wp:inline></w:drawing></w:r></w:p>
    <w:p><w:pPr><w:numPr><w:ilvl w:val="0"/><w:numId w:val="1"/></w:numPr></w:pPr><w:r><w:t>第一项</w:t></w:r></w:p>
    <w:p><w:pPr><w:numPr><w:ilvl w:val="1"/><w:numId w:val="1"/></w:numPr></w:pPr><w:r><w:t>嵌套项</w:t></w:r></w:p>
...
<w:footnotes xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:footnote w:id="1"><w:p><w:r><w:t>脚注内容</w:t></w:r></w:p></w:footnote></w:footnotes>"#;
        let endnotes = r#"<?xml version="1.0" encoding="UTF-8"?>
<w:endnotes xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:endnote w:id="2"><w:p><w:r><w:t>尾注内容</w:t></w:r></w:p></w:endnote></w:endnotes>"#;
        let core = r#"<?xml version="1.0" encoding="UTF-8"?>
<cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/"><dc:title>夹具图书</dc:title><dc:creator>测试作者</dc:creator><dc:subject>回归</dc:subject><dc:language>zh-CN</dc:language><dcterms:created>2026-09-18</dcterms:created></cp:coreProperties>"#;
        let app = br#"<?xml version="1.0" encoding="UTF-8"?><Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties"><Application>FolioForge Fixture</Application></Properties>"#;
        let image = b"\x89PNG\r\n\x1a\nfixture";
        package_with_parts(&[
    ...
    #[test]
    fn rich_docx_decodes_to_semantic_ir_without_word_types() {
        let package = DocxPackage::open(&rich_docx(), &DocxLimits::default()).unwrap();
        let (book, diagnostics) = Decoder::new(package, false).decode().unwrap();
        assert_eq!(book.metadata.title.as_deref(), Some("夹具图书"));
        assert_eq!(book.metadata.author_names(), ["测试作者"]);
        assert_eq!(book.metadata.language.as_deref(), Some("zh-CN"));
        assert_eq!(book.documents.len(), 3);
        assert!(all_text(&book).contains("第一章"));
        assert!(all_text(&book).contains("脚注内容"));
        assert!(all_text(&book).contains("尾注内容"));
        let features = book.feature_summary();
        for feature in [
            "heading",
            "emphasis",
            "link",
            ...
            assert!(features.contains_key(feature), "missing feature {feature}");
        }
        assert!(book.anchors.iter().any(|anchor| anchor.name == "intro"));
        assert!(book
            .anchors
            .iter()
            .any(|anchor| anchor.name == "footnote-1"));
        assert!(book.anchors.iter().any(|anchor| anchor.name == "endnote-2"));
        assert!(book
            .navigation
            .toc
            .iter()
            .any(|point| point.label == "第一章"));
        assert!(book
            .navigation
            .anchor_graph
            .edges
            .iter()
            .any(|edge| edge.target == "https://example.test/chapter"));
        assert_eq!(book.resources.len(), 1);
        assert_eq!(book.resources[0].kind, ResourceKind::Png);
        assert_eq!(
            book.load_resource(ResourceId::new(0), None).unwrap(),
            b"\x89PNG\r\n\x1a\nfixture"
        );
        assert!(book.styles.iter().any(|(_, style)| {
            style.get("font-weight") == Some("bold") && style.get("color") == Some("#AA5500")
        }));
        assert!(diagnostics
            .iter()
            .any(|diagnostic| diagnostic.code == "DOCX-P006"));
        assert!(!diagnostics
            .iter()
            .any(|diagnostic| diagnostic.code == "DOCX-M002"));
    }

    #[test]
    fn package_gate_rejects_macro_and_traversal_inputs() {
        let content_types = br#"<Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types"><Override PartName="/word/document.xml" ContentType="application/vnd.ms-word.document.macroEnabled.main+xml"/></Types>"#;
        let macro_package = package_with_parts(&[("[Content_Types].xml", content_types), ("word/document.xml", b"<w:document xmlns:w=\"http://schemas.openxmlformats.org/wordprocessingml/2006/main\"/>")]);
        assert!(matches!(
            DocxPackage::open(&macro_package, &DocxLimits::default()),
            Err(DocxError::MacroEnabled)
        ));

        let traversal = package_with_parts(&[("../word/document.xml", b"unsafe")]);
        assert!(matches!(
            DocxPackage::open(&traversal, &DocxLimits::default()),
            Err(DocxError::Invalid(message)) if message.contains("unsafe ZIP path")
        ));
    }

    #[test]
    fn package_gate_rejects_doctype_and_missing_main_part() {
        let missing_main = package_with_parts(&[
            (
                "[Content_Types].xml",
        ...
        assert!(matches!(
            DocxPackage::open(&missing_main, &DocxLimits::default()),
            Err(DocxError::Invalid(message)) if message.contains("missing required word/document.xml")
        ));

        let doctype = package_with_parts(&[
            (
                "[Content_Types].xml",
                br#"<!DOCTYPE Types><Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types"><Override PartName="/word/document.xml" ContentType="application/vnd.openxmlformats-officedocument.wordprocessingml.document.main+xml"/></Types>"#,
            ),
            ("word/document.xml", b"<w:document xmlns:w=\"http://schemas.openxmlformats.org/wordprocessingml/2006/main\"/>")
        ]);
        assert!(matches!(
            DocxPackage::open(&doctype, &DocxLimits::default()),
            Err(DocxError::Invalid(message)) if message.contains("DOCTYPE")
        ));
    }
}
